...
import { User, Phone, Fingerprint, Calendar, FileText, Download, CheckCircle, MessageSquare, Send } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div className="p-8 bg-slate-50 border-t border-slate-100 flex justify-end">
          <button
            ...
            className="bg-slate-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-slate-800 transition-all disabled:opacity-50 shadow-lg"
          >
